...
"""SM-only firmware providers for the common IOT2050 firmware task core."""
...
MODULE_FIRMWARE_SOCKET = "unix:///run/iot2050/module-firmware.sock"
...
def _wait_module_operation(stub, operation_id, operation_request, timeout=3600):
...
def _module_inspection_response(response):
    if not response.ok:
...
class ModuleFirmwareProvider:
    ...
    def inspect(self, request):
        ...
        try:
            ...
            channel.close()
        return _module_inspection_response(response)
