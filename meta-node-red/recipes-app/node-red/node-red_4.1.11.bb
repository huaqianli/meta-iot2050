...
#
# Or more recommended:
# Run the script in corresponding Debian snapshot environment from the
# meta-iot2050 repository root:
#  ./scripts/host/regenerate-npm-shrinkwraps.sh [path/to/meta-iot2050]
#
